...
public class GUIScrambleFurnace extends GuiContainer
{
    ...
    public GUIScrambleFurnace(InventoryPlayer playerInv, IInventory furnaceInv)
    {
        super(new ContainerScrambleFurnace(playerInv, furnaceInv));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.mc.getTextureManager().bindTexture(SCRAMBLE_FURNACE_TEXTURE);
        int i = (this.width - this.xSize) / 2;
        int j = (this.height - this.ySize) / 2;
        this.drawTexturedModalRect(i, j, 0, 0, this.xSize, this.ySize);

        if (TileEntityScrambleFurnace.isBurning(this.tileFurnace))
        {
