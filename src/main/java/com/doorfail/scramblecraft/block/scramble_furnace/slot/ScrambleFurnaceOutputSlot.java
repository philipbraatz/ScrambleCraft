...
public class ScrambleFurnaceOutputSlot extends Slot
{
    private final EntityPlayer player;
    private int removeCount;

    public ScrambleFurnaceOutputSlot(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
