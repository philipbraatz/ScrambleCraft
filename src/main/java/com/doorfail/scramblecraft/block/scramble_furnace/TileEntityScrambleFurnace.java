...
public class TileEntityScrambleFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.scramble_furnace";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityScrambleFurnace.class, new String[] {"Items"}));
    }
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        {
            ItemStack itemStack = this.furnaceItemStacks.get(1);
            return isItemFuel(stack) || ScrambleFurnaceFuelSlot.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
        }
    }
    ...
    {
        return "tutorialmod:scramble_furnace";
    }

    @Override
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new ContainerScrambleFurnace(playerInventory, this);
    }
