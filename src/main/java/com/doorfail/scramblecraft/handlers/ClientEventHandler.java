...
import com.doorfail.scramblecraft.recipe.recipe_book.ScrambleBook;
...
//
                ...
                //                    rl.updateKnownRecipes(new ScrambleBook((Minecraft.getMinecraft()).player.getRecipeBook()));
                //                }
                //            }
//
...
//
                ...
                //                continue;
                //            }
                //            List<ScrambleList> list = new ArrayList<ScrambleList>();
...
//
                ...
                //                        }
                //                    }
                //                    recList.updateKnownRecipes(new ScrambleBook((Minecraft.getMinecraft()).player.getRecipeBook()));
                //                    list.add(recList);
                //                }
                //                cache.put(ct, list);
                //            }
